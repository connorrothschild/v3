...
featured: true
img: nuxt-blog-starter/header.png
...
You can see the impact of SSR on performance by comparing my [last blog iteration](https://developers.google.com/speed/pagespeed/insights/?url=https%3A%2F%2Fconnorrothschild.github.io%2Fv2%2F&tab=desktop) to [this one](https://developers.google.com/speed/pagespeed/insights/?url=https%3A%2F%2Fwww.connorrothschild.github.io/v3%2F&tab=desktop).
...
<InlineImage src="post/nuxt-blog-starter/old-site-perf.png" alt="Old site performance. 72/100" width="48%"></InlineImage>
<InlineImage src="post/nuxt-blog-starter/new-site-perf.png" alt="New site performance. 100/100" width="48%"></InlineImage>
...
<InlineImage src="post/nuxt-blog-starter/dark.png" alt="Dark mode" width="49%"/></InlineImage>
<InlineImage src="post/nuxt-blog-starter/light.png" alt="Light mode" width="49%"/></InlineImage>
...
<InlineImage src="post/nuxt-blog-starter/transitions.gif" alt="GIF showcasing transitions of home page, to blog post pagfe, to a single blog post."></InlineImage>
