(window.webpackJsonp = window.webpackJsonp || []).push([
  ...
  Array(241).concat([
    ...
    function (t, n, e) {
          ...
          [
            function () {
              var t = this,
                n = t.$createElement,
                e = t._self._c || n;
              return e("footer", { staticClass: "site-footer" }, [
                e(
                  "div",
                  {
                    staticClass:
                      "content has-text-centered site-footer-content",
                  },
                  [
                    e("p", [
                      ...
                      t._v(". The source code is available on\n      "),
                      e(
                        "a",
                        {
                          staticClass: "link",
                          attrs: {
                            href: "https://github.com/connorrothschild/v3",
                            target: "_blank",
                            rel: "noopener noreferrer",
                          },
                        },
      ...
      n.default = component.exports;
      installComponents(component, { Footer: e(492).default });
    },
    ,
    ,
    ,
      ...
      n.a = function (meta) {
        return [
          ...
          },
          {
            hid: "twitter:site",
            name: "twitter:site",
            content: (meta && meta.twitterSite) || "@CL_Rothschild",
          },
          {
            hid: "twitter:card",
            name: "twitter:card",
            content: (meta && meta.twitterCard) || "summary_large_image",
          },
        ];
      };
    },
